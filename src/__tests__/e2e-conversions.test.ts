...
const parsers: Record<SessionSource, () => Promise<UnifiedSession[]>> = {
  ...
  qoder: parseQoderSessions,
  qodercli: async () => [],
  qoderwork: parseQoderWorkSessions,
};
...
const extractors: Record<SessionSource, (s: UnifiedSession) => Promise<SessionContext>> = {
  ...
  qoder: extractQoderContext,
  qodercli: extractQoderContext,
  qoderwork: extractQoderWorkContext,
};
