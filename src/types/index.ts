...
export interface UnifiedSession {
  ...
  summary?: string;
  /** Source session's native title (AI-generated or user-renamed), read from
   *  the source tool's own registry. Displayed in pickers/lists in preference
   *  to `summary`; absent when the source has no native title concept. */
  title?: string;
